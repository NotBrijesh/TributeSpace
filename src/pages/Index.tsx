...
const Index = () => {
  ...
  return (
    <>
      {!showContent && <EntranceAnimation onComplete={() => setShowContent(true)} />}
      {showContent && (
        <div className="min-h-screen bg-background relative overflow-x-hidden">
          ...
          <MemoryWall memories={memories} onDelete={refresh} />
          <RandomMemory />
          ...
          >
            ...
            <p className="text-muted-foreground font-sans text-sm mt-6">Made with 💖 by Brijesh</p>
          </motion.footer>
        </div>
      )}
    </>
