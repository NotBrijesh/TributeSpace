...
const MemoryForm = ({ onSubmit }: { onSubmit: () => void }) => {
  ...
  const handleSubmit = () => {
    ...
    saveMemory({ from: from.trim(), to: to.trim(), message: message.trim() });
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground font-sans">
            Write something beautiful for someone who made your year special.
          </p>
        </motion.div>
          ...
          <AnimatePresence mode="wait">
            {submitted ? (
              ...
              <motion.div key="form" className="space-y-5">
                ...
                {/* Message */}
                <div>
                  <label className="block text-sm font-sans font-medium text-foreground mb-2">Your Message</label>
                  <textarea
                    ref={textareaRef}
                    value={message}
                    onChange={(e) => setMessage(e.target.value.slice(0, MAX_CHARS))}
                    placeholder="Write something they'll remember forever..."
                    rows={5}
                ...
                <motion.button
                  ...
                  disabled={!from.trim() || !to.trim() || !message.trim()}
